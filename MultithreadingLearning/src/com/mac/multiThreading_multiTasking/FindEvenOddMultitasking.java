package com.mac.multiThreading_multiTasking;

public class FindEvenOddMultitasking {
	...
	public void displayOddNumber() {
		// note that synchronized blocks are necessary for the code for getting the
		// desired
	...
	public static void main(String[] argvs) {
		...
		FindEvenOddMultitasking oe = new FindEvenOddMultitasking();
